...
public class AtalayaApplication {
	...
	public String consultaranalisis(
			@RequestParam(value = "nombreanalisis", defaultValue = "prueba")String nombreAnalisis,
			@RequestParam(value = "nombre", required = false)String nombre,
			@RequestParam(value = "tipo", required = false)String tipo,
			@RequestParam(value = "valor", required = false) String valor
			) {

		System.out.print("nombre:"+nombreAnalisis);
		int cumplido = -1;
		...
		{	
			...
			mensaje.append("</br>Ejecutando el analisis: <b>"+ analisis.getNombre() + "</b></br>");
