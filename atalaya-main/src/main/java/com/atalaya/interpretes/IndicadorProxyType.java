...
public class IndicadorProxyType {
	...
	public Indicador copiaIndicador (Indicador ind)
	{
		...
		boolean stopper = ind.getStopper();
		
		Indicador ind_copia = new Indicador(nombre, descripcion, fuente, tipo, comando, parametros_copia, resultado, configuraciones, stopper); 
